package dao.karma.custombond.tokens;
...
public class PrincipalToken extends IRC2BasicPrincipalToken {
  public PrincipalToken () {
    super("PrincipalToken", "PrincipalToken", 18);
    this._mint(Context.getCaller(), BigInteger.valueOf(100_000).multiply(MathUtils.pow10(18)));
  }
}

abstract class IRC2BasicPrincipalToken {
  ...
  public IRC2BasicPrincipalToken(String _name, String _symbol, int _decimals) {
