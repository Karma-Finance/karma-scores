...
package dao.karma.standards.token.irc2;
...
public class IRC2Mintable extends IRC2Basic {

    private final VarDB<Address> minter = Context.newVarDB("minter", Address.class);

    public IRC2Mintable(String _name, String _symbol, int _decimals, BigInteger _initialSupply) {
