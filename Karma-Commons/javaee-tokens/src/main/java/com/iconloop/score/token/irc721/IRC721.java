...
public class IRC721 {
  ...
  /**
   * Internal function to invoke {IIRC721Receiver-onIRC721Received} on a target address.
  ...
  protected boolean _checkOnIRC721Received(
    ...
    if (to.isContract()) {
        Context.call(to, "onIRC721Received", Context.getCaller(), from, tokenId, _data != null ? _data : "".getBytes());
    }
