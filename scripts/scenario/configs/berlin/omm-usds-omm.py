...
OMM_USDS = "cx4d3b86709c387dec2927158c0377ecabe002f503"
OMM_USDS_LP_POOL_ID = 12
...
config = {
  ...
  "bond": {
    "default": {
      ...
      "initialize": {
        "controlVariable": hex(977777),
        "minimumPrice": hex(0),
        "maxPayout": hex(1),
        "maxDebt": hex(70_000 * 10**18),
        "initialDebt": hex(1000 * 10**18),
        "maxDiscount": hex(0),  # 10%
      },
    },
    ...
    "implementation": {
      ...
      "principalPoolId": hex(OMM_USDS_LP_POOL_ID),
    },
  },
  ...
  "treasury": {
    "default": {
      ...
      "initialPayoutFunding": hex(1 * 10**18), # 20k OMM
    },
  },
}
