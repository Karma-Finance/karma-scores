...
# send 100K payoutToken to the custom treasury
echo '{}' | jq \
  --arg _to $customTreasury \
  '{method: "transfer", params: {_to: $_to, _value: "0x152d02c7e14af6800000", _data: "0x7b226d6574686f64223a2266756e64696e67227d"}}' > ./config/calls/bond-payouttoken/${endpoint}/customtreasury_initial_deposit.json
